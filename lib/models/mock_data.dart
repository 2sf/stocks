...
//    netIncome: [22526000000,7422650000,33362570000,34516760000,37187040000,2021,],
...
final companySamples = <Company>[
  Company(
    companyName: 'Grameenphone LTD.',
    companyInitials: 'GP',
    companyDescription: 'Grameenphone Ltd. is a telecommunications company. The Company provides a range of products and services, such as prepaid, including Nishchinto, Bondhu and Shohoj; postpaid, including Xplore, Xplore Legend and Business Solution Ekota; roaming, including outbound roaming and inbound roaming; Internet of things mobile for development (IOT M4D) and device, including handset feature phone and smartphone, and Internet and connected device third generation (3G) modem, 3G router, wearables and accessories; Internet 3G; Internet second generation (2G); enterprise solution, including voice message broadcast and vehicle tracking system; digital services, including Comoyo and wowbox; value added services, including instant messaging and miss call alert, and adjacent businesses, such as financial services and infrastructure services. It provides financial services in electronic ticketing, bill collection, electronic lottery and partner bank services under the brand MobiCash. \n Number of employees : 2 086 people.',
    companyMarketCap: '486.92B',
    totalRevenue : [114862160000,128435814000,132831967000,143656271000,139606161000,2021,0],
    netIncome: [22526000000,27422650000,33362570000,34516760000,37187037000,2021,0],// find out if this should be before tax currently values are after tax
    netCashFlowFromOperations: [46152000000,57783000000,60413000000,57393000000,33572000000,2021,0],
    netProfitAfterTax: [22526000000,27422650000,33362570000,34516760000,37187037000,2021,0],// couldn't find it for GP
    totalOpratingIncome: [41461000000,49954390000,56776980000,66651830000,63439610000,2021,0],
    interestExpense: [2016,285354000,245781000,298764000,326398000,2021,0],// current data from GP finantial statement conflicting info on WSJ and investing.com (each has diff value)
    currentAssets: [9823000000,20658344000,13368698000,20999170000,9930970000,2021,0],
    currentLiabilities: [6807900000,74540711000,82963383000,90426222000,76656374000 ,2021,0],
    totalLongTermDebt: [18650000000,13469480000,7603130000,13484110000,14146840000,2021,0],
  ),
  Company(
    ...
    companyMarketCap: '148.69B',
    totalRevenue : [2016,2017,2018,2019,2020,2021,0],
    netIncome: [2016,2017,2018,2019,2020,2021,0],
    netCashFlowFromOperations: [2016,2017,2018,2019,2020,2021,0],
    netProfitAfterTax: [2016,2017,2018,2019,2020,2021,0],
    totalOpratingIncome: [2016,2017,2018,2019,2020,2021,0],
    interestExpense: [2016,2017,2018,2019,2020,2021,0],
    currentAssets: [2016,2017,2018,2019,2020,2021,0],
    currentLiabilities: [2016,2017,2018,2019,2020,2021,0],
    totalLongTermDebt: [2016,2017,2018,2019,2020,2021,0],
  ),
  Company(
    companyName: 'GRAMEENPHONE LTD. (GP)',
    companyInitials: 'GP',
